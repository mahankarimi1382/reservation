  ...
  return (
    <div className=" w-full bg-blue-300 lg:h-full h-[150px] relative flex justify-center items-center">
      ...
      <div className=" flex-wrap lg:flex-row w-full lg:w-[80%] absolute flex justify-between">
        <div className="  w-1/2 lg:w-1/4 text-[10px] lg:text-base flex text-white pl-2 lg:pl-0  justify-center items-center flex-col">
          <Image
            width={110}
        ...
        <div className=" pr-2 lg:pr-0 w-1/2 lg:w-1/4 text-[10px] lg:text-base flex text-white justify-center items-center flex-col">
          <Image
            width={110}
            className=" xs:w-8 w-5 sm:w-10 md:w-[40%]"
            src={doctor}
        ...
        <div className=" pl-2 lg:pl-0 w-1/2 lg:w-1/4 text-[10px] lg:text-base flex text-white justify-center items-center flex-col">
          <Image
            className=" xs:w-8 w-5 sm:w-10 md:w-[40%]"
            width={110}
            src={telephone}
