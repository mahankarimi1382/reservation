...
function HospitalsSection_dentist() {
  const hospitals = [
    {
      id: 1,
          ...
          return (
            ...
            >
              <div className=" flex justify-center lg:gap-10 gap-5 w-full items-center">
                <div className=" justify-center flex w-1/3">
                  <div className=" lg:w-[97px] lg:h-[97px] rounded-full border border-[#4282F7] p-2 lg:p-4">
                    <Image alt="hospital-icon" src={hospitalIcon} />
                  </div>
                </div>
                <div className=" lg:gap-3 gap-2 text-start flex-col flex ">
                  <h2 className=" text-[16px] lg:text-[18px]">{items.name}</h2>
              ...
              <div className=" flex gap-1 lg:gap-2">
                <h5 className=" px-2 rounded-full flex justify-center font-medium items-center lg:text-[14px] text-[11px] lg:px-5 lg:h-[22px] bg-[rgba(200,254,47,0.25)]">
                  {items.loc}
                </h5>
                <h5 className=" px-2  text-[11px] font-medium rounded-full flex items-center lg:text-[14px] justify-center lg:px-5 lg:h-[22px] bg-[rgba(244,118,1,0.1)]">
                  {items.skills} تخصص
                </h5>
                <h5 className=" px-2  text-[11px] font-medium rounded-full flex items-center lg:text-[14px] justify-center lg:px-5 lg:h-[22px] bg-[rgba(128,241,146,0.2)]">
...
export default HospitalsSection_dentist;
