          ...
          return (
            ...
            >
              ...
              <div className=" flex gap-1 lg:gap-2">
                <h5 className=" px-2 rounded-full flex justify-center font-medium items-center lg:text-[14px] text-[11px] lg:px-5 lg:h-[22px] bg-[rgba(47,254,242,0.25)]">
                  {items.loc}
                </h5>
                <h5 className=" px-2  text-[11px] font-medium rounded-full flex items-center lg:text-[14px] justify-center lg:px-5 lg:h-[22px] bg-[rgba(1,98,244,0.1)]">
                  {items.skills} تخصص
                </h5>
                <h5 className=" px-2  text-[11px] font-medium rounded-full flex items-center lg:text-[14px] justify-center lg:px-5 lg:h-[22px] bg-[rgba(144,241,128,0.2)]">
...
export default HospitalsSection_Psychiatry;
