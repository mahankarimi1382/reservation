      ...
      <div className=" gap-10 mt-20 w-full flex flex-col items-center ">
        ...
        <div className=" gap-3 flex flex-col w-[80%] rounded-lg border shadow-md p-4 bg-white">
          <div className=" py-2 w-full flex rounded-lg bg-[#F4F4F4]">
            <h4 className=" gap-2 text-[#005DAD] font-semibold w-[16%] flex justify-center  items-center text-lg">
              <input className=" border-[#005DAD] border" type="checkbox" />
              همه
            </h4>
            <h4 className=" w-[16%] flex justify-center  items-center text-[#3F444D] ">
              کاربران مسدود شده <TiArrowSortedDown />
            </h4>
            <h4 className=" w-[16%] flex justify-center items-center text-[#3F444D] ">
              کد ملی <TiArrowSortedDown />
            </h4>
            <h4 className=" w-[16%] flex justify-center items-center text-[#3F444D] ">
              تاریخ مسدود شدن <TiArrowSortedDown />
            </h4>
            <h4 className=" w-[16%] flex justify-center items-center text-[#3F444D] ">
              دلیل مسدود شدن <TiArrowSortedDown />
            </h4>
            <h4 className=" w-[16%] flex justify-center items-center text-[#3F444D] ">
              عملیات مدیریتی
              <TiArrowSortedDown />
