...
import step2pay from "../../../public/assets/step2pay.png";
import PayDetails from "@/components/pay/PayDetails";
import discountIcon from "../../../public/assets/discount-shape.png";
import cardIcon from "../../../public/assets/card.png";
import cardIcon_white from "../../../public/assets/card-white.png";
import samanBank from "../../../public/assets/samanBank.png";
function page() {
  return (
    <div className=" flex flex-col justify-center py-10 gap-10 items-center" dir="rtl">
      ...
      <div className=" flex gap-6 w-[90%]">
        ...
        <div className="border-[#005DAD] flex gap-10 flex-col justify-center items-center p-4 rounded-xl border w-[45%]">
          ...
          <button className=" gap-2 w-[305px] py-3 rounded-xl flex justify-center items-center text-xl text-white bg-[#005DAD] ">
