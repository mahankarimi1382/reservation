...
function Navbar({params}) {
  ...
  return (
    <div className="vazir w-full mt-5 lg:mt-0  lg:px-20 px-5 h-36 flex justify-between items-center">
      {isOpen && <LoginModals setIsOpen={setIsOpen} />}
      ...
      <button
        onClick={openModal}
        className=" lg:-mt-12 bg-white shadow-xl text-[12px] lg:text-[16px] lg:p-2 p-1 px-2 lg:px-4 flex justify-center items-center gap-1 text-[#004D8F] rounded-lg border border-[#004D8F]"
      >
