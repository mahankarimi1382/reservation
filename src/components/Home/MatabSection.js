...
import MattabIcon from "../../../public/assets/MattabIcon.png";
            ...
            >
              <div className=" flex justify-center lg:gap-10 gap-5 w-full items-center">
                ...
                <div className=" lg:gap-3 gap-2 text-start flex-col flex ">
                  <h2 className=" text-[12px] lg:text[16px]">{items.name}</h2>
              ...
              <div className=" flex gap-1 lg:gap-2">
                <h5 className=" px-2 rounded-full flex justify-center font-medium items-center text-[11px] lg:px-5 lg:h-[22px] bg-[rgba(76,254,47,0.25)]">
                  {items.loc}
                </h5>
                <h5 className=" px-2  text-[11px] font-medium rounded-full flex items-center justify-center lg:px-5 lg:h-[22px] bg-[rgba(250,252,122,0.21)]">
                  {items.skills} تخصص
                </h5>
                <h5 className=" px-2  text-[11px] font-medium rounded-full flex items-center justify-center lg:px-5 lg:h-[22px] bg-[rgba(212,128,241,0.2)]">
