          ...
          return (
            ...
            >
              ...
              <div className=" flex gap-1 lg:gap-2">
                <h5 className=" px-2 rounded-full flex justify-center font-medium items-center text-[11px] lg:px-5 lg:h-[22px] bg-[rgba(254,182,47,0.25)]">
                  {items.loc}
                </h5>
                <h5 className=" px-2  text-[11px] font-medium rounded-full flex items-center justify-center lg:px-5 lg:h-[22px] bg-[rgba(244,1,1,0.1)]">
                  {items.skills} تخصص
                </h5>
                <h5 className=" px-2  text-[11px] font-medium rounded-full flex items-center justify-center lg:px-5 lg:h-[22px] bg-[rgba(128,173,241,0.2)]">
