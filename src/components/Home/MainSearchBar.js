import heroPerson from "../../../public/assets/hero-small-pesron-pic.png";
import heroArrow from "../../../public/assets/heroArrow.png";
import heroLines from "../../../public/assets/3lines.png";
  ...
  return (
    <div className=" flex flex-col gap-5 mb-10 lg:mb-0 lg:gap-9 justify-center items-center">
      ...
      <h2 className=" -mt-10 font-semibold lg:font-medium text-[18px] flex gap-1 lg:gap-3 lg:text-[38px]">
        با
        <section className=" text-[#005DAD]">دکتر رزرو</section>
      ...
      <div className=" gap-6 w-[100%] -mt-10  lg:w-3/5 flex lg:mt-20 justify-center items-center rounded-xl h-[119px]">
        ...
        <button className=" hidden text-lg font-thin gap-2 rounded-xl bg-[#005DAD] h-[56px] text-white w-[146px] lg:flex justify-center items-center">
