...
import karenLogo from "../../../public/assets/karenLogo.png";
...
import userTag from "../../../public/assets/user-tag.png";
import favoriteChart from "../../../public/assets/favorite-chart.png";
const allCenters = [
  {
    id: 1,
        ...
        return (
          ...
          >
            ...
            <div className=" w-full justify-end  flex">
              <button className=" text-white flex rounded-xl justify-center items-center bg-[#005DAD] p-2">
                نوبت بگیرید
