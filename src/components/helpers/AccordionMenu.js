...
import OperatorPic from "../../../public/assets/OperatorPic.png";
      ...
      <div className=" m-4 lg:m-0 lg:w-1/2 lg:-mt-32 lg:mr-20">
        ...
        <Accordion expanded={isOpen} onChange={()=>{setIsOpen(!isOpen)}}>
          <AccordionSummary
            ...
            id="panel1-header"
          >
            +آیا اطلاعات من در سایت ذخیره می شود؟
          </AccordionSummary>
          <AccordionDetails className=" flex flex-col gap-5 text-[#817D7D]">
            <hr />
            بله ، ما از پروتکل های امنیتی پیشرفته برای حفاظت از اطلاعات شخصی و
            پزشکی شما استفاده می کنیم و تمام داده ها رمز گذاری شده اند، پس از
            این بابت آسوده خاطر باشید.
          </AccordionDetails>
        </Accordion>
        <Accordion
